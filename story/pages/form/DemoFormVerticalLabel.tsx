    ...
    return () => (
        <div>
            ...
            <DemoRow title={'单列居中表单'}>
                <PlForm column={1} centerWhenSingleColumn verticalLabel>
                    <PlFormItem label={'客户名称'} field={'name'}>
                        <PlInput v-model={formData.name}/>
                    </PlFormItem>
                    <PlFormItem label={'客户员工数量'} field={'type'}>
