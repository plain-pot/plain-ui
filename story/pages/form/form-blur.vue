        ...
        <demo-row title="基本用法">
            <pl-form ref="form" v-model="form1.formData" contentWidth="400px" :disabled="disabled">
                ...
                <pl-form-item label="级联选择" field="field61" :rules="{required:true,trigger:'blur'}">
                    <pl-cascade :data="treeData" labelField="name" keyField="id" childrenField="subs" v-model="form1.formData.field61" @focus="log('focus')" @blur="log('blur')"/>
                </pl-form-item>
                ...
                <pl-form-item label="颜色选择器" field="field14" :rules="{required:true,trigger:'blur'}">
                    <pl-color-picker v-model="form1.formData.field14" @focus="log('focus')" @blur="log('blur')"/>
                </pl-form-item>

                <pl-form-item label="时间选择" field="field15" :rules="{required:true,trigger:'blur'}">
                    <pl-time v-model="form1.formData.field15" @blur="log('blur')"/>
                </pl-form-item>
