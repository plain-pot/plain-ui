<template>
    <div class="demo-dialog">
        ...
        <im-demo-row title="将dom移动到body下面">
            ...
            <im-button label="init transfer-dom" @click="init = !init"/>
            <im-dialog ref="transferDomDialog" transfer-dom dialog-class="transferDomDialog" v-if="init">transfer-dom</im-dialog>
        </im-demo-row>
