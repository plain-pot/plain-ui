                ...
                menuGroups: [
                    ...
                    },
                    {
                        ...
                        menus: [
                            ...
                            {title: '图片列', icon: 'pl-table-solid', page: '/plain-table/demo-plain-table-img', complete: true},
                    ...
                    },
                    {
                        ...
                        menus: [
                            ...
                            {title: 'BaseTable方法', icon: 'pl-table-solid', page: '/table/demo-base-table-methods', complete: true},
                        ],
                    },
                    {
                        title: '测试',
