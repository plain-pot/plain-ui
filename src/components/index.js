...
import simpleImg from './img/pl-simple-img'
...
const components = {
    ...
    step, stepContainer, tabs, tab, tabHeader, navPages, nav, row, col, container, upload, progressBar, progressCircle, progressMini, img, simpleImg,
