<template>
    <div class="pl-cascade-panel">
        <div class="pl-cascade-list" v-for="(list,listIndex) in cascadeData" :key="listIndex">
            <div v-for="node in list"
                 class="pl-cascade-item"
                 :class="[{'pl-cascade-item-expand':node.key === expandKeys[listIndex]}]"
                 :key="node.key"
                 @click="onClickItem(node)">
...
<script lang="ts">
    ...
    export default {
        ...
        created() {
            console.log(this.formatData, this.cascadeData)
        },
        computed: {
