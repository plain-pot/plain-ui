...
export const StyleProps = {
    shape: {type: String as PropType<keyof typeof StyleShape>},                      // fillet,round,square
    size: {type: String as PropType<keyof typeof StyleSize>},                       // normal,large,mini
    status: {type: String as PropType<keyof typeof StyleStatus>},                     // primary,success,error,warn,info
}
