...
*/
import {InheritHtmlElement,computed, designComponent, reactive, useModel, useRefs, useStyles, watch} from "plain-design-composition";
...
export const PlProgressCircle = designComponent({
    ...
    setup({props, slots, event}) {
        ...
        return {
            ...
            render: () => (
                <div class={`pl-progress-circle ${loading.isLoading ? 'pl-progress-circle-loading' : ''}`} style={styles.value} ref={onRef.el}>
...
export default PlProgressCircle
