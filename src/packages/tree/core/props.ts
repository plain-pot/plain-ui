...
export const TreeProps = {
    ...
    nodeIcon: {type: Function as any as new() => nodeIcon},// 节点图标
    ...
    // 普通属性
    renderContent: {type: Function as any as new() => renderContent},// 树节点内容渲染函数
    filterNodeMethod: {type: Function as any as new() => filterNodeMethod},// 对树节点进行筛选的方法，返回true表示可以显示，返回false表示隐藏
    ...
    isCheckable: {type: Function as any as new() => isCheckable},// 当即将选中树节点时，判断是否可以选中该树节点
