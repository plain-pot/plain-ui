...
export const TreeProps = {
    ...
    filterNodeMethod: {type: Function as PropType<filterNodeMethod>},// 对树节点进行筛选的方法，返回true表示可以显示，返回false表示隐藏
    ...
    isLeaf: {type: Function as PropType<isLeaf>},// 判断树节点是否为叶子节点的函数，仅在lazy模式有效
    getChildren: {type: Function as PropType<getChildren>},// 加载子节点数据的函数，仅当 lazy 为true时有效
    ...
    isCheckable: {type: Function as PropType<isCheckable>},     // 当即将选中树节点时，判断是否可以选中该树节点
