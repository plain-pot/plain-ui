<template>
    <div class="demo-dropdown">
        <demo-row title="dropdown service">
            <demo-row title="基本用法">
                <pl-button label="toggle" @click="basic.toggle" ref="basic"/>
            </demo-row>
        </demo-row>
        <demo-row title="pl-dropdown">
            <demo-row title="基本用法">
                <pl-dropdown ref="dropdown">
                    ...
                    <pl-dropdown-menu slot="dropdown">
                        ...
                        <pl-dropdown-item label="导入" @click="$message('导入')"/>
            ...
            <demo-row title="触发器">
                <pl-dropdown ref="sizeDropdown" width="100" height="200px" v-for="item in ['click','focus','hover']" :key="item" :trigger="item">
                    ...
                    option: {
                        props: {
                            ...
                            content: (h) => {
                                return (
                                    <pl-dropdown-menu>
                                        <pl-dropdown-item label="新建"/>
                                        <pl-dropdown-item label="编辑"/>
                                        <pl-dropdown-item label="删除"/>
                                    </pl-dropdown-menu>
                                )
                            },
                            ...option,
