export default [
    ...
    },
    {
        name: '表单', children: [
            ...
            {name: 'Timer', title: '时间选择', icon: 'pl-time-circle-light', page: '/normal/time', complete: true},
    ...
    {
        name: '导航', children: [
            {name: 'Tabs', title: '页签', icon: 'pl-tabs', page: '/normal/tabs', complete: true},
            {name: 'TabsHeader', title: '页签标题', icon: 'pl-tabs', page: '/normal/tab-header', complete: true},
            {name: 'NavTab', title: '页签导航', icon: 'pl-tabs', page: '/nav/nav-tab', complete: true},
            {name: 'NavPages', title: '页面导航', icon: 'pl-page', page: '/nav/nav-page', complete: true},
            {name: 'Nav', title: '应用导航', icon: 'pl-tabs', page: '/nav/nav', complete: true},
        ]
    },
    {
        name: '其他', children: [
    ...
    {
        name: '表格', children: [
            {name: 'Table Basic', title: '基础表格', icon: 'pl-table-solid', page: '/table/base-table', complete: true},
            {name: 'Table Fixed Column', title: '固定列', icon: 'pl-table-solid', page: '/table/base-table-fixed', complete: true},
            {name: 'Table Fill', title: '宽高填满父元素', icon: 'pl-table-solid', page: '/table/base-table-fit-parent', complete: true},
            {name: 'Table Basic Props', title: '基本属性', icon: 'pl-table-solid', page: '/table/base-table-props', complete: true},
            {name: 'Table Edit', title: '基本编辑', icon: 'pl-table-solid', page: '/table/base-table-edit', complete: true},
            {name: 'Table Column Props', title: '列属性', icon: 'pl-table-solid', page: '/table/base-table-column-prop', complete: true},
            {name: 'Table Dynamic Control', title: '列动态控制', icon: 'pl-table-solid', page: '/table/base-table-dynamic', complete: true},
            {name: 'Table Column Slots', title: '列插槽', icon: 'pl-table-solid', page: '/table/base-table-slot', complete: true},
            {name: 'Table Tooltip', title: '列显示', icon: 'pl-table-solid', page: '/table/base-table-tooltip', complete: true},
            {name: 'Table Columns', title: '列组件', icon: 'pl-table-solid', page: '/table/base-table-column', complete: true},
            {name: 'Table Methods', title: '方法', icon: 'pl-table-solid', page: '/table/base-table-methods', complete: true},
        ]
    },
    {name: '指令'},
    {
        name: '其他', children: [
            {name: 'Test', title: '测试手动渲染实例', icon: 'pl-table-solid', page: '/normal/render-func', complete: true},
            {name: 'plain-popper', title: '原始 popper 对象', icon: 'pl-table-solid', page: '/normal/plain-popper', complete: true},
        ]
    },
]